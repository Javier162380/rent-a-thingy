...
var Cities = []string{"Amsterdam", "Rotterdam", "Utrech"}
...
func engineMetadata(city string) (map[string]Engine, error) {
	...
	case "Amsterdam":
		metaData["funda"] = Engine{
			...
			SortBy:              []string{"date ↓", "date ↑", "relevance", "rental price", "floor area", "availability"}}
		metaData["pararius"] = Engine{
			...
			SortBy:              []string{"date ↓", "rental price ↑", "rental price ↓", "living area ↑", "living area ↓"}}
